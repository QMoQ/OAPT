...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, x_size):
        ...
        if self.input_resolution == x_size:
            ...
            attn_windows = self.attn(x_windows, mask=self.calculate_mask([h1, w1]).to(x.device))
...
class SwinIRShift(nn.Module):
    r""" SwinIRNoShift  remove shiftwindow
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
                 ...
                 **kwargs):
        super(SwinIRShift, self).__init__()
        num_in_ch = in_chans
        num_out_ch = in_chans
        num_feat = 64
