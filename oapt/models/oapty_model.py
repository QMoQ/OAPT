...
from oapt.models.myb_model import calculate_psnrb1
import numpy as np
import math
...
from oapt.models.myy_model import ycbcr2rgb1, rgb2ycbcr1
import time
import os

@MODEL_REGISTRY.register()
class OAPT_ModelY(BaseModel): 
    def __init__(self, opt):
        super(OAPT_ModelY, self).__init__(opt) 
        # define network
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            # psnr_b_record_out[idx] = calculate_psnrb1(sr_img,gt_img,input_mode='input')
